...
resources: poddisruptionbudgets: "kube-system": "calico-kube-controllers": {
	...
	spec: {
		maxUnavailable: 1
		selector: matchLabels: "k8s-app": "calico-kube-controllers"
	}
}
resources: serviceaccounts: "kube-system": "calico-kube-controllers": {
	// Source: calico/templates/calico-kube-controllers.yaml
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
...
resources: serviceaccounts: "kube-system": "calico-node": {
...
resources: configmaps: "kube-system": "calico-config": {
...
resources: customresourcedefinitions: "": "bgpconfigurations.crd.projectcalico.org": {
...
resources: customresourcedefinitions: "": "bgppeers.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
...
resources: customresourcedefinitions: "": "blockaffinities.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
...
resources: customresourcedefinitions: "": "caliconodestatuses.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
...
resources: customresourcedefinitions: "": "clusterinformations.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
...
resources: customresourcedefinitions: "": "felixconfigurations.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							bpfMapSizeNATAffinity: type: "integer"
...
resources: customresourcedefinitions: "": "globalnetworkpolicies.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		...
		group:
			"crd.projectcalico.org", names: {
			kind:
				"GlobalNetworkPolicy", listKind:
				"GlobalNetworkPolicyList", plural:
				"globalnetworkpolicies", singular:
				"globalnetworkpolicy"
		}, preserveUnknownFields:
			false, scope:
			"Cluster", versions: [{
			name:
				"v1", schema: openAPIV3Schema: {
				properties: {
					apiVersion: {
						description: "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
...
resources: customresourcedefinitions: "": "globalnetworksets.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
		...
		group:
			"crd.projectcalico.org", names: {
			kind:
				"GlobalNetworkSet", listKind:
				"GlobalNetworkSetList", plural:
				"globalnetworksets", singular:
				"globalnetworkset"
		}, preserveUnknownFields:
			false, scope:
			"Cluster", versions: [{
...
resources: customresourcedefinitions: "": "hostendpoints.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
		...
		group:
			"crd.projectcalico.org", names: {
			kind:
				"HostEndpoint", listKind:
				"HostEndpointList", plural:
				"hostendpoints", singular:
				"hostendpoint"
		}, preserveUnknownFields:
			false, scope:
			"Cluster", versions: [{
...
resources: customresourcedefinitions: "": "ipamblocks.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
...
resources: customresourcedefinitions: "": "ipamconfigs.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
		...
		group:
			...
			kind:
				"IPAMConfig", listKind:
				"IPAMConfigList", plural:
				"ipamconfigs", singular:
				"ipamconfig"
		}, preserveUnknownFields:
			false, scope:
			"Cluster", versions: [{
...
resources: customresourcedefinitions: "": "ipamhandles.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
		"ipamhandles.crd.projectcalico.org", spec: {
		group:
			"crd.projectcalico.org", names: {
			kind:
				"IPAMHandle", listKind:
				"IPAMHandleList", plural:
				"ipamhandles", singular:
				"ipamhandle"
		}, preserveUnknownFields:
			false, scope:
			"Cluster", versions: [{
...
resources: customresourcedefinitions: "": "ippools.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
...
resources: customresourcedefinitions: "": "ipreservations.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: {
		annotations: "controller-gen.kubebuilder.io/version":
			"(devel)", creationTimestamp: null
		name:
		...
		group:
			"crd.projectcalico.org", names: {
			kind:
				"IPReservation", listKind:
				"IPReservationList", plural:
				"ipreservations", singular:
				"ipreservation"
		}, preserveUnknownFields:
			false, scope:
			"Cluster", versions: [{
...
resources: customresourcedefinitions: "": "kubecontrollersconfigurations.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
		"kubecontrollersconfigurations.crd.projectcalico.org", spec: {
		group:
			"crd.projectcalico.org", names: {
			kind:
				"KubeControllersConfiguration", listKind:
				"KubeControllersConfigurationList", plural:
				"kubecontrollersconfigurations", singular:
...
resources: customresourcedefinitions: "": "networkpolicies.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
		...
		group:
			"crd.projectcalico.org", names: {
			kind:
				"NetworkPolicy", listKind:
				"NetworkPolicyList", plural:
				"networkpolicies", singular:
				"networkpolicy"
		}, preserveUnknownFields:
			false, scope:
			"Namespaced", versions: [{
...
resources: customresourcedefinitions: "": "networksets.crd.projectcalico.org": {
	// Source: calico/templates/kdd-crds.yaml
	apiVersion:
		"apiextensions.k8s.io/v1", kind:
		"CustomResourceDefinition", metadata: name:
		"networksets.crd.projectcalico.org", spec: {
		group:
			"crd.projectcalico.org", names: {
			kind:
				"NetworkSet", listKind:
				"NetworkSetList", plural:
				"networksets", singular:
				"networkset"
		}, preserveUnknownFields:
			false, scope:
			"Namespaced", versions: [{
...
resources: clusterroles: "": "calico-kube-controllers": {
	// Source: calico/templates/calico-kube-controllers-rbac.yaml
	// Include a clusterrole for the kube-controllers component,
	// and bind it to the calico-kube-controllers serviceaccount.
	kind:
		"ClusterRole", apiVersion:
		"rbac.authorization.k8s.io/v1", metadata: name:
		"calico-kube-controllers", rules: [{
...
resources: clusterroles: "": "calico-node": {
...
resources: clusterrolebindings: "": "calico-kube-controllers": {
	// Source: calico/templates/calico-kube-controllers-rbac.yaml
	kind:
		"ClusterRoleBinding", apiVersion:
		"rbac.authorization.k8s.io/v1", metadata: name:
		"calico-kube-controllers", roleRef: {
		apiGroup:
		...
		kind:
			"ServiceAccount", name:
			"calico-kube-controllers", namespace:
			"kube-system"
	}]
}
resources: clusterrolebindings: "": "calico-node": {
	// Source: calico/templates/calico-node-rbac.yaml
	apiVersion:
		...
		kind:
			"ServiceAccount", name:
			"calico-node", namespace:
			"kube-system"
	}]
}
resources: daemonsets: "kube-system": "calico-node": {
	// Source: calico/templates/calico-node.yaml
	...
	kind:
		...
		name:
			"calico-node", namespace:
			"kube-system", labels: "k8s-app":
			"calico-node"
	}, spec: {
		selector: matchLabels: "k8s-app": "calico-node", updateStrategy: {
			type:
				"RollingUpdate", rollingUpdate: maxUnavailable: 1
		}, template: {
			metadata: labels: "k8s-app": "calico-node", spec: {
				...
				volumes: [{
					...
					name: "cni-log-dir"
					hostPath: path: "/var/log/calico/cni"
				}, {
					// Mount in the directory for host-local IPAM allocations. This is
					// used when upgrading from host-local to calico-ipam, and can be removed
					// if not using the upgrade-ipam init container.
					name: "host-local-net-dir"
					hostPath: path: "/var/lib/cni/networks"
				}, {
...
resources: deployments: "kube-system": "calico-kube-controllers": {
	// Source: calico/templates/calico-kube-controllers.yaml
	...
	apiVersion:
		...
		replicas:
			1, selector: matchLabels: "k8s-app": "calico-kube-controllers", strategy: type:
			"Recreate", template: {
			metadata: {
