...
#ClusterSpec: {
	...
	waitTimeoutForHealthyOSDInMinutes?: uint @go(WaitTimeoutForHealthyOSDInMinutes)
...
#ObjectStoreSpec: {
	...
	// +optional
	// +nullable
	healthCheck?: #BucketHealthCheckSpec @go(HealthCheck)
...
#BucketHealthCheckSpec: {
	// +optional
	bucket?: #HealthCheckSpec @go(Bucket)
...
#ObjectStoreStatus: {
	...
	// +optional
	bucketStatus?: null | #BucketStatus @go(BucketStatus,*BucketStatus)
...
#BucketStatus: {
	// +optional
	health?: #ConditionType @go(Health)
...
#KerberosConfigFiles: {
	...
	volumeSource?: null | v1.#VolumeSource @go(VolumeSource,*v1.VolumeSource)
}
...
#DisruptionManagementSpec: {
	...
	osdMaintenanceTimeout?: uint @go(OSDMaintenanceTimeout)
	...
	pgHealthCheckTimeout?: uint @go(PGHealthCheckTimeout)
