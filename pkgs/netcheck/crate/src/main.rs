...
fn main() {
  ...
  let ping_hosts = &[
    ...
    "2606:4700:4700::1111",
    "2606:4700:4700::1001",
    "2a01:7e00::f03c:91ff:fe77:738c", "campanella2.pub.s.cascade",
    "2a01:4f8:151:8047::2", "beagle2.pub.s.cascade",
    ...
    "fca5:cade:1::1:3", "saelli.cv.s.cascade",
    "fca5:cade:1::1:4", "motog5.cv.s.cascade",
    ...
    "fca5:cade:1::2:7", "moon.cl.s.cascade",
    ...
    "192.168.2.7", "moon.cl4.s.cascade",
    "beagle2.h.cascade",
    "campanella2.h.cascade",
    "altusanima.h.cascade",
    "saelli.h.cascade",
    "motog5.h.cascade",
    "shadowshow.h.cascade",
    "bonito.h.cascade",
    "cherry.h.cascade",
    "moon.h.cascade",
    "coloris.h.cascade",
